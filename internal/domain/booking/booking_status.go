...
const (
	...
	StatusPickupArrived BookingStatus = "pickup_arrived"
...
var validTransitions = map[BookingStatus][]BookingStatus{
	...
	StatusAccepted:      {StatusPickupArrived, StatusInProgress, StatusCancelled, StatusRequested},
	StatusPickupArrived: {StatusInProgress, StatusCancelled},
