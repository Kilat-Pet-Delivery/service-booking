...
func main() {
	...
	if cfg.AppEnv == "development" {
		if err := db.AutoMigrate(&repository.BookingModel{}, &repository.BookingItemModel{}, &repository.IdempotencyKeyModel{}, &repository.PetModel{}, &repository.PhotoModel{}); err != nil {
